...
[Arminia](https://arminia.com.au/) is a website that explores the 2D / 3D geometry of the unified field and the 13 Information Systems of the Fruit of Life. The construction of geometry is done with [Geogebra](https://www.geogebra.org/), which is used as an online straight edge and compass. The straight edge and compass is a tool that can reveal powerful relationships in geometry, line and number. When a workbook or challenge is complete, the user will gain diagrams, art and instructions to build the construction with a real straight edge and compass.
